    ...
    private void startShowingControllerData(){
        while(true)
        {
            ...
            for(int i=0; i < components.length; i++)
            {
                ...
                // Buttons
                //if(component.getName().contains("Button") || componentIdentifier.getName().matches("^[0-9]*$") ){ // If the language is not english, this won't work.
                //if(componentIdentifier.getName().matches("^[0-9]*$")){ // If the component identifier name contains only numbers, then this is a button.
                if(component.getName().contains("Button") || 
                   component.getName().contains("Base") || 
                   component.getName().contains("Thumb") || 
                   component.getName().contains("Top") || 
                   component.getName().contains("Pinkie") || 
                   component.getName().contains("Trigger")  ){
                // Is button pressed?
                    ...
                    continue;
                } //else {System.out.println("The component " + component.getName() + "  is not a button");}
